---
layout: post
title: OverTheWire Bandit 1-10
published: true
---
There's no single solution in cybersecurity. When I can do multiple solutions for these, I will explain how to do it.
...
Then enter the password bandit0 when prompted
```
